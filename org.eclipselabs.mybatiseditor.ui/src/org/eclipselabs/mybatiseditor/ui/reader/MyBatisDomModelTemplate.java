...
/**
 * Utility class for working with an XML DOM model, validating that it is a
 * MyBatis or iBatis mapper file, and releases the model when done.
 * 
 * @author Peter Hendriks
 * 
 * @param <T>
 *            The return type of the {@link #doWork(IDOMModel)} method.
 */
